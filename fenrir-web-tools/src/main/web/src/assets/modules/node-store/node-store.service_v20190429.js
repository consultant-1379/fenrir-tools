...
nodeStoreModule.factory("nodeStoreService", function(pouchDB) {
  ...
  service.getNetworkFromCatalogById = function(networkId) {
    ...
    return service.db
       .createIndex(service.DB.QUERY.INDEX.NETWORK.BY_ID.replace(networkId))
  ...
  service.getSimulationsForNetwork = function(network) {
    ...
    function querySimulationsForNetwork(indexCreationResult) {
      ...
      return service.db
        .find(service.DB.QUERY.SELECTOR.NETWORK.BY_ID.replace(network.id))
    ...
    return service.db.createIndex(service.DB.QUERY.INDEX.NETWORK.BY_ID)
